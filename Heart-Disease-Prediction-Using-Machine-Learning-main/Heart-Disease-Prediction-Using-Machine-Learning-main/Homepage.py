...
st.write("In order to most effectively use our model, we recommend you fill out all of your information and then compare to the provided mean values. By doing so, you will be able to identify what specifically is the variable that is leading to heart disease for you. Recommendations for fixing these habits, as well as an explanation of the variables, are provided in the \"Health Recommendations\" page")